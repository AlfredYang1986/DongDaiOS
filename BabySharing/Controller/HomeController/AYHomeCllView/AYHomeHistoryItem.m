...
- (void)initialize {
    ...
    titleLabel = [Tools setLabelWith:titleLabel andText:nil andTextColor:[Tools garyColor] andFontSize:12.f andBackgroundColor:nil andTextAlignment:NSTextAlignmentLeft];
    ...
    contentCountlabel = [Tools setLabelWith:contentCountlabel andText:nil andTextColor:[Tools garyColor] andFontSize:11.f andBackgroundColor:nil andTextAlignment:NSTextAlignmentLeft];
    ...
    psLabel = [Tools setLabelWith:psLabel andText:nil andTextColor:[Tools garyColor] andFontSize:10.f andBackgroundColor:nil andTextAlignment:NSTextAlignmentLeft];
...
- (void)setItemInfo:(NSDictionary *)itemInfo {
    ...
    NSArray *options_title_cans = @[@"绘本",@"儿童瑜伽",@"音乐",@"舞蹈",@"情商训练"];
