...
- (UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
	...
	UILabel *titleLabel = [Tools creatUILabelWithText:titleStr andTextColor:[Tools garyColor] andFontSize:317.f andBackgroundColor:nil andTextAlignment:NSTextAlignmentLeft];
