...
- (instancetype)init {
	if (self = [super init]) {
		...
		dateLabel =  [Tools creatLabelWithText:@"Service Date" textColor:[Tools blackColor] fontSize:14.f backgroundColor:nil textAlignment:NSTextAlignmentLeft];
		...
		timeLabel =  [Tools creatLabelWithText:@"Service Time" textColor:[Tools themeColor] fontSize:16.f backgroundColor:nil textAlignment:NSTextAlignmentLeft];
