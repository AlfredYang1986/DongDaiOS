...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        orderNo_ = [Tools creatLabelWithText:@"ASDASDASDASDASFDFS" textColor:[Tools blackColor] fontSize:17.f backgroundColor:nil textAlignment:0];
        ...
        titleLabel = [Tools creatLabelWithText:@"服务标题" textColor:[Tools blackColor] fontSize:20.f backgroundColor:nil textAlignment:0];
