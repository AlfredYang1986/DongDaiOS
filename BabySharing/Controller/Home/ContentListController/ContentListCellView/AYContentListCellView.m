...
#import "AYContentListCellView.h"
...
@interface AYContentListCellView ()
...
@implementation AYContentListCellView
...
- (void)setUpReuseCell {
    id<AYViewBase> cell = VIEW(@"ContentListCell", @"ContentListCell");
