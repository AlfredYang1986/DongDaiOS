...
#import "AYHomeLookAfterCellView.h"
...
@implementation AYHomeLookAfterCellView {
...
- (void)setUpReuseCell {
	id<AYViewBase> cell = VIEW(@"HomeLookAfterCell", @"HomeLookAfterCell");
...
- (void)didMoreBtnClick {
	[self performNotify:@"" withResult:nil];
}
