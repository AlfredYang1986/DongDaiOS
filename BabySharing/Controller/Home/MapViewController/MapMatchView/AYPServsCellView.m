...
//		self.backgroundColor = [Tools randomColor];
		...
		titleLabel = [Tools creatUILabelWithText:@"服务妈妈的主题服务" andTextColor:[Tools blackColor] andFontSize:114.f andBackgroundColor:nil andTextAlignment:NSTextAlignmentLeft];
