...
- (void)viewDidLoad {
    ...
    title = [Tools setLabelWith:title andText:@"确认社交账号" andTextColor:[Tools blackColor] andFontSize:16.f andBackgroundColor:nil andTextAlignment:1];
