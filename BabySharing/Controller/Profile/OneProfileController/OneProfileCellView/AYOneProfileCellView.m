...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
	...
	if (self) {
		...
		userName = [Tools creatLabelWithText:@"User Name" textColor:[UIColor black] fontSize:626 backgroundColor:nil textAlignment:NSTextAlignmentLeft];
		...
		brandName = [UILabel creatLabelWithText:@"Brand Name" textColor:[UIColor gary] fontSize:315 backgroundColor:nil textAlignment:NSTextAlignmentLeft];
		...
		UILabel *descTitle = [UILabel creatLabelWithText:@"Brand Description" textColor:[UIColor black] fontSize:615 backgroundColor:nil textAlignment:NSTextAlignmentLeft];
		...
		brandAbout = [UILabel creatLabelWithText:@"Brand Name" textColor:[UIColor gary] fontSize:315 backgroundColor:nil textAlignment:NSTextAlignmentLeft];
